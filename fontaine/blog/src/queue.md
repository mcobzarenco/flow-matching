...
**16 open** (Live 0 · Queued 2 · Blocked 14 · Done 174)
...
**boundary:** Queued 03:2xZ 08-15 at the collector close (depth refill). Executable CPU now (launcher + audit code); its preconditions (the demo set) land with stage B. · [pre-reg](posts/2026-08-14-prereg-grasp-sft-bootstrap.md)
