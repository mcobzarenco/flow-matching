...
**boundary:** Queued 01:5xZ 08-18 work session at the draft cut. OWNER-GATED: launch pends the GO on the draft post (standing ask goes in-channel with the draft summary). Everything CPU-side is staged: launcher full-parse green, serving-row instrument landed with oracles, decision grid + gates frozen in the draft. · [pre-reg](posts/2026-08-18-prereg-grasp-sft-v2-joint-pdnorm.md)
