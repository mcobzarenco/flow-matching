"""Upload the demos+one-rig endpoint (step 3000) to fontaine-checkpoints.
...
grasp_demos_v2/merged + so101_pick_place_v2 (x4) ONLY (clean dropped —
the one-recipe-delta isolation cell vs the convicted pdnorm mixed
cell); 3000 steps eff-96 on the local H100, unit
fontaine-v2-joint-pdnorm-onerig launched 18:22:47Z 2026-08-19;
pre-reg posts/2026-08-19-prereg-demos-plus-one-rig.md. Banked at the
endpoint verdict (frozen-grid sim100 read) per the standing
banked-checkpoints rule.
"""
...
RUN_DIR = Path.home() / "checkpoints/finetune/grasp_sft_v2_joint_1gpu_pdnorm_onerig"
STEP_DIR = RUN_DIR / "step_003000"
DEST = "grasp_sft_v2_joint_pdnorm_onerig_step3000"
