...
**Updated:** 2026-08-08T23:20:00+00:00

**Depth call:** depth 3 at 23:2xZ 08-08: 60k LIVE (box, close ~23:2xZ) + cleancand q4 LIVE (local, rc=0 ~00:4xZ); queued: fieldgen fields-panel (armed, opens at 60k close+eval), molmo2-perf-pass1-exec box ladder (post-fields-panel), fieldcond meta-report (post-fields-panel); noise-ladder rung 2 FULLY CLOSED this session (stage-2 falsified + seating confirmed -> board row moved)

**13 open** (Live 2 · Queued 3 · Blocked 8 · Done 48)
...
**boundary:** rc=0 ~00:4xZ 08-09 (31.7 f/min cumulative, 992/4301 at 22:58Z) -&gt; frozen reads ONE command: uv run python fontaine/scripts/subgoal_draws_results.py --candidate-filter clean --draws-stem reports/eval__bijou_arb_rcond_100k_ddp4__step_100000__stateprobe_q4_subgoalcleandraws · [pre-reg](posts/2026-08-08-prereg-subgoal-draws-cleanlist.md)
