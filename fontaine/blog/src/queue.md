...
**boundary:** Queued 18:3xZ 08-17 work session (refill at prereg-draft close). Blocked on nothing; disk has ~490 GB free after the v2 pull. Do NOT delete the HF mirrors ever — they are now the only durable copies.
