...
Usage::
    ...
    uv run python -m bijou.modelling.gemma4.verify_parity --device cuda --max-new-tokens 32
    uv run python -m bijou.modelling.gemma4.verify_parity --device cuda --attn-backend eager \
        --require-bitwise
    uv run python -m bijou.modelling.gemma4.verify_parity --device cuda --attn-backend sdpa \
        --long-context 600
"""
