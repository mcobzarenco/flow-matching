...
def parse_args() -> TrainArgs:
    ...
    try:
        # Fail fast, before any data/model build; select_datasets re-parses
        # at use (TrainArgs keeps the raw strings for checkpoint replay).
        parse_repeat_specs(tuple(raw.dataset_repeat))
