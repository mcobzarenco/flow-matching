#!/usr/bin/env bash
# fontaine box batch — A-s1 (ctl, seed 1) on GPU 2.
...
if [ "$mem" -gt 1024 ]; then echo "GPU 2 busy (${mem} MiB) — abort"; exit 1; fi
...
.venv/bin/python -m bijou.train \
    ...
    --wandb-run-name fontaine_arb_rcond_40k_1xh100_s1 \
    --save-dir outputs/train/fontaine_arb_rcond_40k_1xh100_s1 \
    2>&1 | tee /home/ubuntu/train_fontaine_arb_rcond_40k_1xh100_s1.log
...
.venv/bin/python -m bijou.eval \
    ...
    --checkpoint outputs/train/fontaine_arb_rcond_40k_1xh100_s1/step_040000 \
    --batch-size 32 --num-workers 20 --seed 0 \
    --report-samples 32 \
    --dump-predictions reports/eval__fontaine_arb_rcond_40k_1xh100_s1__step_040000__panel_curated_v0_k4l2.npz \
    --output-json reports/eval__fontaine_arb_rcond_40k_1xh100_s1__step_040000__panel_curated_v0_k4l2.json \
    --report reports/eval__fontaine_arb_rcond_40k_1xh100_s1__step_040000__panel_curated_v0_k4l2.html \
    2>&1 | tee /home/ubuntu/eval_fontaine_arb_rcond_40k_1xh100_s1_40k.log
echo "=== A-s1 DONE (train + panel eval) ==="
