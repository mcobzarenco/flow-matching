#!/usr/bin/env bash
# fontaine box batch — B-s0 (auxoff, seed 0) on GPU 1.
...
.venv/bin/python -m bijou.train \
    ...
    --wandb-run-name fontaine_arb_rcond_auxoff_40k_1xh100 \
    --save-dir outputs/train/fontaine_arb_rcond_auxoff_40k_1xh100 \
    2>&1 | tee /home/ubuntu/train_fontaine_arb_rcond_auxoff_40k_1xh100.log
...
.venv/bin/python -m bijou.eval \
    ...
    --checkpoint outputs/train/fontaine_arb_rcond_auxoff_40k_1xh100/step_040000 \
    --batch-size 32 --num-workers 20 --seed 0 \
    --report-samples 32 \
    --dump-predictions reports/eval__fontaine_arb_rcond_auxoff_40k_1xh100__step_040000__panel_curated_v0_k4l2.npz \
    --output-json reports/eval__fontaine_arb_rcond_auxoff_40k_1xh100__step_040000__panel_curated_v0_k4l2.json \
    --report reports/eval__fontaine_arb_rcond_auxoff_40k_1xh100__step_040000__panel_curated_v0_k4l2.html \
    2>&1 | tee /home/ubuntu/eval_fontaine_arb_rcond_auxoff_40k_1xh100_40k.log
echo "=== B-s0 DONE (train + panel eval) ==="
