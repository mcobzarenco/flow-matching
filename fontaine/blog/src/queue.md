...
**16 open** (Live 1 · Queued 3 · Blocked 12 · Done 275)
...
**boundary:** Queued 09:1xZ 08-22 at the leg B incident close. CPU-workable any window (diagnosis on the archived ckpt; a 5-step resume on GPU only for final verification at a free window). Until fixed: NO --resume on flow/joint lineages — recover by full retrain.
