...
**Updated:** 2026-08-13T11:08:00Z

**Depth call:** depth 3: molmoact2-ar-head-port item (d) launch-ready on owner go (else (b2) parity prep); token-grpo-phase2-instrument items 3-4 (retargeted to the molmoact2 surface); sim-arm-photometric-links pre-reg.
