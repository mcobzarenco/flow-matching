...
**Updated:** 2026-08-08T20:20:00+00:00

**Depth call:** depth 5 at 19:5xZ 08-08: 60k LIVE (box, ~23Z close) + noiseladder SEATING live (local, ~22:25Z rc=0); queued: fieldgen fields-panel (armed, opens at 60k close), molmo2-perf-pass1-exec box ladder (post-close), idea6 rung-(b') cleancand execution (launch-only, opens at seating rc=0), fieldcond meta-report composition (post-fields-panel); rung-2 stage-2 DONE (falsified) this session

**13 open** (Live 1 · Queued 4 · Blocked 8 · Done 48)
...
**boundary:** launched ~10:1xZ 08-08; 20k steps at ~2.2 s/step ~= 12.2h -&gt; endpoint ~22:3x-23:0xZ 08-08 + chained panel eval; babysit entry molmo2_ar60k live; first babysit validates async-save lines + util/rate · [pre-reg](posts/2026-08-08-prereg-molmo2-ar-60k-continuation.md)
...
**boundary:** opens at molmo2_ar40k endpoint (~2026-08-08), after the #19 draws-arm box obligations; needs the endpoint checkpoint (warm-start is part of the measured shape); GREEN required BEFORE EITHER arm launches — the ladder's batch verdict is matched (a sub-B12 green downshifts F too, so F must not start at B12 first) — REQUEUED BEHIND the molmo2 60k continuation (owner priority call 09:04Z 08-08): opens when fontaine-molmo2-60k lands (~23Z 08-08) and the 60k-vs-40k read decides the warm-start checkpoint (repoint amendment + K-smoke re-run if 60k wins) · [pre-reg](posts/2026-08-07-prereg-molmo2-attach-screen.md)
...
**boundary:** opens strictly after: molmo2_ar40k endpoint saves -&gt; chained greedy + #19 draws arm (that pre-reg's box obligations first) -&gt; K smoke ladder green (#20 checkpointing LANDED 08-07) -&gt; molmo2-stage2-attachment-decision opens (owner steer window) — REQUEUED BEHIND the molmo2 60k continuation (owner priority call 09:04Z 08-08): opens when fontaine-molmo2-60k lands (~23Z 08-08) and the 60k-vs-40k read decides the warm-start checkpoint (repoint amendment + K-smoke re-run if 60k wins) · [pre-reg](posts/2026-08-07-prereg-molmo2-attach-screen.md)
