"""Upload the grasp_sft_v2_joint endpoint (step 3000) to fontaine-checkpoints.
...
owner's re-converted molmoact2-so101-released, v2 regen corpus
(fontaine-grasp-demos-v2, expert v1.3): 3 datasets / 4551 train
episodes / 1,879,795 frames, holdout 506; 3000 steps eff-96 on
8xA100, unit fontaine-grasp-sft-v2-joint launched 09:57:39Z
2026-08-17 (smoke skipped on the owner's 09:47Z order); pre-reg
posts/2026-08-17-prereg-grasp-sft-v2-joint.md.
"""
...
RUN_DIR = Path.home() / "checkpoints/finetune/grasp_sft_v2_joint_8xa100"
STEP_DIR = RUN_DIR / "step_003000"
DEST = "grasp_sft_v2_joint_step3000"
