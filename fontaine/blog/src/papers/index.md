...
| [Label-free selection signals](label-free-selection-signals.md) | 2605.10158, 2606.14084 | #6 scorer rung design constraint (score the SET, not the candidate — read the same session as the NO-SCORER verdict), #19/#1 jerk-selector free read on banked draws, #1 rung-3 |
